execute as @a[scores={carrot=1..}] at @s run summon minecraft:armor_stand ^ ^ ^1 {Tags:["ray"]}
...
execute as @e[tag=ray] at @s unless block ~ ~-1 ~1 air run summon minecraft:sheep ~ ~ ~ {Tags:["sheep"]}
